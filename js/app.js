// event handler and Load Data
 ...
 emptyField.innerText =`Please Write valid text!!`;
 if(searchText === ''){
...
//results found or not validation
  ...
  totalFoundResults.innerText = `About ${totalResult} results & showing ${filterBooks.length} books `;
  ...
  filterBooks.slice(0,20).forEach(filterBook =>{
         ...
         <div class="card-body">
           <h3 class="card-title text-light">${filterBook.title}</h3>
           <h5 class="card-title text-light">By ${filterBook.author_name[0]}</h5>
           <h6 class="card-title text-light">First Published:${filterBook.first_publish_year} </h6>
           <h6 class="card-title text-light">Publisher:${filterBook.publisher[0]} </h6>
